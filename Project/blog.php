...
<body>
  <nav class="fh5co-nav " role="navigation">
		<div class="container">
        <div class="row">
        <a class = "logo" href="product.html">Flowers.</a>
  ...
  <section class="py-5" id="content" >
    <div class="container">
      <div class="row">
        <div class="col product" style="width: 20rem;">
          <a href="imp2.php" ><img src="./assets/img/b-3.jpg">
          </a>
            <div class="post">
              <sPan class="post-item"><a href="#"></a> MODERN</sPan>
              <span>Apr 21, 2020</span>
            </div>
            <p>Being in Harmony with Design Trends in 2021</p>
          
        </div>
        <div class="col product" style="width: 15rem;">
          <a href="imp3.php"><img src="./assets/img/b-1.jpg" >
          </a>
          <div class="post">
              <sPan class="post-item"><a href="#"></a> MODERN</sPan>
              <span>Apr 21, 2020</span>
        ...
        <div class="col product">
          <a href="imp1.php"><img src="./assets/img/b-2.jpg">
          </a>
          <div class="post">
              <sPan class="post-item"><a href="#"></a> MODERN</sPan>
              <span>Apr 21, 2020</span>
